                ...
                <div class="col-md-6 offset-md-3 p-4 rounded-4 shadow-lg">
                    <form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="pb-3">
                            ...
                            <input type="text" id="title" name="title" edit
                        ...
                        <div class="pb-3">
                            ...
                            <input type="datetime-local" id="reg_open_at" name="reg_open_at"
                                class="form-control @error('reg_open_at') is-invalid @enderror">
                            @error('reg_open_at')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="pb-3">
                            ...
                            <input type="datetime-local" id="reg_close_at" name="reg_close_at"
                                class="form-control @error('reg_close_at') is-invalid @enderror">
                            @error('reg_close_at')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
