                    ...
                    <div class="p-4 rounded shadow d-flex flex-column gap-4">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $registration->coupon->code ?? 'Tidak menggunakan kupon' }}</td>
                            </tr>
                            <tr>
                        ...
                        @else
                            @if (!$registration->payment_proof)
                                <form action="{{ route('payment.proof', $registration->id) }}" method="POST"
                            ...
                            @else
                                <div class="">
                                    ...
                                    <img src="{{ asset("storage/images/payment/$registration->payment_proof") }}"
                                        alt="" height="300px" data-bs-toggle="modal" data-bs-target="#modal"
                                        class="image">
                                </div>
                            @endif
                        @endif
